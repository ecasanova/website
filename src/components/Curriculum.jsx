...
,
  ...
  },
  {
    ...
    "description": "Fullstack developer for Samsung sales force monitoring app Colombia, Panama, and India. Skills: Angular 8, Material UI, REST, React, React Native"
  },
  {
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {skills.map((skill, index) => (
                  <Skills key={index} title={skill.title} skills={skill.skills} />
                ))}
              </div>
            </div>
            <div>
